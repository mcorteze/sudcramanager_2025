...
const UltimoProcesoImagen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await axios.get('http://localhost:3001/api/listado_calificaciones_obtenidas_imagen');
  ...
  return (
    <div>
      ...
      <h2>Procesamientos de hojas de respuesta</h2>
        <Table
...
export default UltimoProcesoImagen;
